...
export function Dictionarypage({ navigation }) {
  ...
  // state variable for storing word that has been entered by user
  const [searchWord, setSearchWord] = useState('');

  // state variable for storing the words that has been searched previously 
  const [previousWord, setPreviousWord] = useState('');

  // state variables for searched word, defintion, synonyms and phonetic to store the retrieved data from api 
  ...
  // A function to fetch the previously searched word from AsyncStorage and setting it to previousWord state variable
  ...
  // A function to save the previously searched word to AsyncStorage
...
// A function to fetch data from the dictionary API and display information for the searched word
const connectDictionary = () => {
  ...
  // A function to call the necessary function to take action for entered word
  const searching = () => {
...
// A function to display information for the searched word or the previously searched word
