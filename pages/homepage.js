...
export function Homepage({ navigation, ...props }) {
  ...
  // fetching saved project titles from AsyncStorage
  ...
  // save project title to AsyncStorage
  const saveProjectTitle = async (projecTitleToSave) => {
  ...
  // delete project title from AsyncStorage
  const deleteProject = async (projectId) => {
    try {
      ...
      // deleting the selected projects from the storage
      try {
  ...
  // changing the category of projects
  ...
  //When save button pressed,save the project title as project usestate
  const saveProject = (inputText) => {
    ...
    if (inputtedtitle !== '') {
      if (projectitle.includes(inputtedtitle)) {
        ...
        saveProjectTitle([...projects, newProject]);
        setprojectitle(inputtedtitle);
        settitlemodal(false);
  ...
  //creating project according project added
            ...
            <View style={styles.modal1}>
              <View style={styles.modalContent1}>
                ...
                <Button
                  title="Save"
                  style={{ maring: 5 }}
                  onPress={() => saveProject(text)}></Button>
                <Button
                  title="Cancel"
                  style={{ maring: 5 }}
